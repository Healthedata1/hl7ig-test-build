...
1. **SHALL**support both read Patient by`id`**AND**Patient search using the[_id](SearchParameter-us-core-patient-id.md)search parameter:`GET [base]/Patient?_id=[id]' or 'GET [base]/Patient/[id]`Examples:
> 
1. GET [base]/Patient/1032702
1. GET [base]/Patient?_id=1032702

**Implementation Notes**: Fetches a US Core Patient Profile resource or a search Bundle containing a US Core Patient Profile resource matching the id (see [Parameters for all resources]).
...
**Implementation Notes**: Fetches a bundle of all US Core Patient Profile resources matching the specified birthdate and name ([how to search by date] and ([how to search by string]).
...
**Implementation Notes**: Fetches a bundle of all US Core Patient Profile resources matching the specified birthdate and family ([how to search by date] and ([how to search by string]).
...
**Implementation Notes**: Fetches a bundle of all US Core Patient Profile resources matching the specified death-date and family ([how to search by date] and ([how to search by string]).
