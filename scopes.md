# Scopes - Health eData 1 Sandbox v0.1.0
...
| FamilyMemberHistory | `<patient|user|system>/FamilyMemberHistory.rs` |
...
```
{
  ...
  "scopes_supported": [
    ...
    "user/FamilyMemberHistory.rs",
    "system/FamilyMemberHistory.rs",
    "patient/Goal.rs",
    "user/Goal.rs",
    "system/Goal.rs",
