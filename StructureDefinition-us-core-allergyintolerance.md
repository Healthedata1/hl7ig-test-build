...
**Implementation Notes**: Fetches a bundle of all US Core AllergyIntolerance Profile resources for the specified patient ( see[how to search by reference](foo.md)).

#### Optional Search Parameters:

The following search parameters and search parameter combinations **SHOULD** be supported

1. **SHOULD**support searching using the combination of the[patient](SearchParameter-us-core-allergyintolerance-patient.md)and[clinical-status](SearchParameter-us-core-allergyintolerance-clinical-status.md)search parameters`GET [base]/AllergyIntolerance?patient={Patient/}[id]&clinical-status={system|}[search_code]`Example:
> 
1. GET [base]/AllergyIntolerance?patient=Patient/1137192&clinical-status=http://terminology.hl7.org/CodeSystem/allergyintolerance-clinical|active

**Implementation Notes**: Fetches a bundle of all US Core AllergyIntolerance Profile resources for the specified patient and status code. This will not return any "entered in error" resources because of the conditional presence of the clinicalStatus element. ( see[how to search by reference](foo.md)and[how to search by token](#.md)).
