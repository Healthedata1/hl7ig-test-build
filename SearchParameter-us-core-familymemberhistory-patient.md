# USCoreFamilymemberhistoryPatient - Health eData 1 Sandbox v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **USCoreFamilymemberhistoryPatient**

## SearchParameter: USCoreFamilymemberhistoryPatient 

| | | |
| :--- | :--- | :--- |
| *Official URL*:http://hl7.org/fhir/us/core/SearchParameter/us-core-familymemberhistory-patient | *Version*:0.1.0 | |
| *Standards status:*[Trial-use](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 5 | *Computable Name*:USCoreFamilymemberhistoryPatient |
...
```json
{
  ...
  "id" : "us-core-familymemberhistory-patient",
  "extension" : [
    {
  ...
  "url" : "http://hl7.org/fhir/us/core/SearchParameter/us-core-familymemberhistory-patient",
  "version" : "0.1.0",
