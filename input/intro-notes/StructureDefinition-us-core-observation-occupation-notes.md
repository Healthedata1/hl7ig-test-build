...
{% include quickstart-search.md type=type title=title  category="http://terminology.hl7.org/CodeSystem/observation-category\|social-history" code1="http://loinc.org\|11341-5" single_example=true %}
