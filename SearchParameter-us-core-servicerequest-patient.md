# USCoreServicerequestPatient - Health eData 1 Sandbox v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **USCoreServicerequestPatient**

## SearchParameter: USCoreServicerequestPatient 

| | | |
| :--- | :--- | :--- |
| *Official URL*:http://hl7.org/fhir/us/core/SearchParameter/us-core-servicerequest-patient | *Version*:0.1.0 | |
| *Standards status:*[Trial-use](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 5 | *Computable Name*:USCoreServicerequestPatient |
...
```json
{
  ...
  "id" : "us-core-servicerequest-patient",
  "extension" : [
    {
  ...
  "url" : "http://hl7.org/fhir/us/core/SearchParameter/us-core-servicerequest-patient",
  "version" : "0.1.0",
